...
import com.example.server.Entities.FullPlaylist;
...
//        }
        ...
        String s = request.getParameter("playlistId");

        FullPlaylist fullPlaylist = GetPlaylistQuery.getPlaylist(s);

        String songToReturn = new Gson().toJson(fullPlaylist);
