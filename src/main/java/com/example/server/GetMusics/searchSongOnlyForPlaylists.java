...
@WebServlet("/searchSongOnlyForPlaylists")
public class searchSongOnlyForPlaylists extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Song> songList = SearchSongOnly.searchOnlySong(s);

        String songToReturn = new Gson().toJson(songList);
