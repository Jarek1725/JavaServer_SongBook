...
@WebServlet("/getUserLibraries")
public class getUserLibraries extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String playlists = new Gson().toJson(GetAllUserLibraries.getAllUserLibraries(userId));
